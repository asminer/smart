...
class showdecisionset_si : public proc_noengine {
public:
  showdecisionset_si();
...
showdecisionset_si::showdecisionset_si()
 : proc_noengine(Nothing, em->VOID, "show_decisionset", 2)
{
  SetDocumentation("Displays the values of decision set to the current output stream.");
  result def;
  def.setBool(false);
  SetFormal(1, em->STATESET, "internal"
...
void showdecisionset_si::Compute(traverse_data &x, expr** pass, int ndd)
{
  DCASSERT(x.answer);
  DCASSERT(0==x.aggregate);
  DCASSERT(pass);
...
// ******************************************************************
// *                           show_stateset For Coverability       *
// ******************************************************************

class showstatesetCOV_si : public proc_noengine {
public:
  showstatesetCOV_si();
  virtual void Compute(traverse_data &x, expr** pass, int np);
};
...
void showstatesetCOV_si::Compute(traverse_data &x, expr** pass, int np)
{
  DCASSERT(x.answer);
  DCASSERT(0==x.aggregate);
  DCASSERT(pass);
...
class showdecisions_si : public proc_noengine {
public:
  showdecisions_si();
  virtual void Compute(traverse_data &x, expr** pass, int ndd);
};
...
showdecisions_si::showdecisions_si()
 : proc_noengine(Nothing, em->VOID, "show_decisions", 2)
{
  SetDocumentation("Displays the values of decision set to the current output stream.");
  result def;
  def.setBool(false);
...
void showdecisions_si::Compute(traverse_data &x, expr** pass, int ndd)
{
  DCASSERT(x.answer);
  DCASSERT(0==x.aggregate);
  DCASSERT(pass);
...
// ******************************************************************
// *                           show_states   For Coverability       *
// ******************************************************************

class showstatesCOV_si : public proc_noengine {
public:
  showstatesCOV_si();
  virtual void Compute(traverse_data &x, expr** pass, int np);
};
...
void showstatesCOV_si::Compute(traverse_data &x, expr** pass, int np)
{
  DCASSERT(x.answer);
  DCASSERT(0==x.aggregate);
  DCASSERT(pass);
